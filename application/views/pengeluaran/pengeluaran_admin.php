    ...
    <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <button type="button" class="btn m-1 btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"
                data-bs-whatever="@fat">Tambah Pengeluaran</button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo site_url('pengeluaran/add_pengeluaran_admin') ?>" method="post">
                                <div class="mb-3">
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="box-body">
                        <?php
                        if ($this->session->flashdata('edit_successs')) {
                            echo $this->session->flashdata('edit_successs') . '</div>';
                        }
                        ?>
                        <?php
                        if ($this->session->flashdata('success_pengeluaran')) {
                            echo $this->session->flashdata('success_pengeluaran') . '</div>';
                        }
                        ?>
                        <div class="col-xs-12">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <button type="button" class="btn btn-success m-2"><a
                                                    href="<?php echo site_url('pengeluaran/edit/' . $row['id']) ?>"
                                                    class="text-light">Edit</a></button>

                                            <button type="button" class="btn btn-danger m-2"><a
                                                    href="<?php echo site_url('pengeluaran/pengeluaran_admin_delete/' . $row['id']); ?>"
